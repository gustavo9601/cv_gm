...
;(function($, window, document, undefined){
	...
	OnePageNav.prototype = {
		...
		scrollTo: function(target, callback) {
			...
			var navHeight 	= $('.gm_tm_topbar').outerHeight();
